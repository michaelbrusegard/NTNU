...
def generate_examples(k, lower, upper):
    for _ in range(k):
        A = [
...
if not failed:
    print("Koden ga riktig svar for alle eksempeltestene")#!/usr/bin/python3
# coding=utf-8
import random
